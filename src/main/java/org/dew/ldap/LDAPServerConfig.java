...
class LDAPServerConfig
{
	...
	// ActiveDirectory
	public final static String sCONF_DEF_NAME_CTX  = "defaultNamingContext";
	...
	boolean getBooleanProperty(String sKey, boolean bDefault)
	{
		...
		if(sValue.equals("0") || sValue.equalsIgnoreCase("false") || sValue.equalsIgnoreCase("N")) return false;
		return true;
	}
